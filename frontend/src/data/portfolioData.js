...
export const skills = [
  ...
  { name: 'Penetration Testing', level: 55, category: 'security' },
  { name: 'Python', level: 80, category: 'technical' },
  { name: 'Linux', level: 65, category: 'technical' },
  { name: 'Wireshark', level: 55, category: 'technical' },
  { name: 'Nmap', level: 55, category: 'technical' },
